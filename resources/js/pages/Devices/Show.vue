                  ...
                  <div class="mt-6">
                    ...
                    <div class="flex flex-col space-y-4">
                      ...
                      <div>
                        ...
                        <input type="time" class="rounded border p-2 dark:bg-gray-800 dark:border-gray-600" />
                      </div>
                      <button 
                        @click="controlDevice('adjust')" 
              ...
              <div v-else class="w-full md:w-1/2">
                ...
                <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                  <p class="text-sm text-gray-600 dark:text-gray-300">
                    You do not have permission to control this device. Please contact an administrator if you need to manage this device.
                  </p>
                </div>
              </div>
            </div>
