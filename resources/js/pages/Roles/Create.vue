                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <!-- Permissions -->
                            <div>
                                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300 mb-4">Assign Permissions
                                </h3>

                                <!-- Group: User Management -->
                                <div class="mb-6">
                                    <h4 class="text-md font-medium text-gray-600 dark:text-gray-400 mb-2">User
                                        Management</h4>
                                    <div class="space-y-2 ml-2">
                                        <div v-for="permission in permissions.filter(p => p.name.includes('users'))"
                                            :key="permission.id" class="flex items-center">
                                ...
                                <div class="mb-6">
                                    <h4 class="text-md font-medium text-gray-600 dark:text-gray-400 mb-2">Role
                                        Management</h4>
                                    <div class="space-y-2 ml-2">
                                ...
                                <div class="mb-6">
                                    <h4 class="text-md font-medium text-gray-600 dark:text-gray-400 mb-2">Permission
                                        Management
                                    </h4>
                                    <div class="space-y-2 ml-2">
                                ...
                                <div class="mb-6">
                                    <h4 class="text-md font-medium text-gray-600 dark:text-gray-400 mb-2">Device
                                        Management</h4>
                                    <div class="space-y-2 ml-2">
                                ...
                                <!-- Other Permissions -->
                                <div class="mb-6">
                                    <h4 class="text-md font-medium text-gray-600 dark:text-gray-400 mb-2">Other
                                        Permissions</h4>
                                    <div class="space-y-2 ml-2">
                                        <div v-for="permission in permissions.filter(p =>
                                            ...
                                            !p.name.includes('devices'))" :key="permission.id" class="flex items-center">
                                            <input :id="`permission-${permission.id}`" v-model="form.permissions"
                                                :value="permission.id" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            <label :for="`permission-${permission.id}`"
