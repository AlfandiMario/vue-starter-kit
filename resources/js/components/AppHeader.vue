...
import { LayoutGrid, Menu, Search, UserCog, ShieldPlus, MonitorSpeaker } from 'lucide-vue-next';
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                ...
                                <div class="flex flex-col space-y-4">
                                    <div v-if="canSeeAdminFooter">
                                        <a v-for="item in rightNavItems" :key="item.title" :href="item.href"
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="relative flex items-center space-x-1">
                        ...
                        <div class="hidden space-x-1 lg:flex">
                            <template v-if="canSeeAdminFooter">
