        ...
        <div class="hidden sm:flex sm:items-center sm:ml-6">
          ...
          <div class="ml-3 relative">
            <div class="flex items-center">
              ...
              <button class="bg-white dark:bg-gray-800 rounded-full h-8 w-8 overflow-hidden border border-gray-300 dark:border-gray-700">
                <!-- User avatar or initials -->
                <span class="sr-only">User Menu</span>
                <div class="h-full w-full flex items-center justify-center bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-300">
